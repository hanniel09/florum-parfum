...
export default function section(){
  ...
  const purchases: Purchases[] = [
    ...
    },
    {
      ...
      price: "$299.90",
      imageUrl: "https://data.decoassets.com/florum-parfum/6b4b2c7e-8ce3-4526-978b-cf4d916830a1/coconoir-chanel.jpg",
    ...
    },
    {
      ...
      price: "$169.90",
      imageUrl: "https://data.decoassets.com/florum-parfum/687191ec-037d-4109-8182-57e8c9ecfd4c/FeraGranita.jpg",
        ...
        <div class="flex flex-col justify-center my-3 space-y-5 ">
          {purchases.slice(0,5).map((purchases, index) => (
            ...
            >
              ...
              <h1 class="relative text-[16px] font-semibold ml-[-60px] left-[-60px]">{purchases.perfumeName}</h1>
              <p class="relative text-[16px]  font-semibold ">{purchases.price}</p>
              <p class="relative text-[16px] font-semibold">Units: {purchases.quantity}</p>
              <p class="relative text-[16px] font-semibold">Total price: {purchases.totalPrice}</p>
            </a>
          ))}
        </div>
      </div>
